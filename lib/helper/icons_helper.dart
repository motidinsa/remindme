...
// If you don't use the dot notation described it will attempt to get you an icon favoring the Material icon set using getIconGuessFavorMaterial
  static IconData getIconUsingPrefix({@required String name}) {
...
// Returns an icon named in name favoring Font Awesome
  static IconData getIconGuessFavorFA({@required String name}) {
...
// Returns an icon named in name favoring Material
  static IconData getIconGuessFavorMaterial({@required String name}) {
...
// Kinda self explanatory, no?
  static IconData getMaterialIcon({@required String name}) {
    return iconsMap[name];
  }

// Kinda self explanatory, no?
  static IconData getFontAwesomeIcon({@required String name}) {
    return fontAwesomeIconsMap[name];
  }

  /// Icon data map for Material Icons
  static Map<String, IconData> iconsMap = <String, IconData>{
